...
namespace SimpleRedisQueue.Redis
{
    /// <summary>
    /// AUTHOR: https://gist.github.com/tenowg/c5de38cb1027ab875e56
    ...
    {
        public static Lazy<IConnectionMultiplexer> Connection = null;
        ...
        public event EventHandler<string> OnJobReceived;
        ...
        private async Task HandleNewJobs()
        {
            ...
            {
                // Fire the Event
                OnJobReceived?.Invoke(this, job["payload"]);
